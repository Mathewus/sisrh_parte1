...
@section('conteudo')
    ...
    <div class="container shadow-sm position-relative bg-white pb-3 px-4" style="width:1150px; margin-top:-35px;">
        ...
        <a href="{{ route('cargos.create') }}"
            class="btn btn-primary position-absolute top-0 end-0 m-4 rounded-circle fs-4"><i class="bi bi-plus"></i></a>
        ...
        <form action="" method="get" class="mb-3 d-flex justify-content-end">
            ...
            <div class="input-group me-3">
                <input type="text" name="buscaCargo" class="form-control form-control-lg" placeholder="Nome do cargo">
